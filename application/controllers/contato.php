...
class Contato extends CI_Controller{
	...
	public function index(){
		...
		if($this->input->post('enviar_email') == "enviar"){			
			...
			$this->email->from("contato@privilegiosolaris.com.br","$nome"); //senha: privileg2017
			$this->email->to('contato@privilegiosolaris.com.br');
			$this->email->cc('luiza.maniero@kinea.com.br, tome@vifranconstrutora.com.br, lucineia.santos@vifranconstrutora.com.br, ana.carolina@vifranconstrutora.com.br, carolina.pelaio@vifranconstrutora.com.br, paulobaronista@gmail.com, leadssolarissaovicente@gmail.com');
